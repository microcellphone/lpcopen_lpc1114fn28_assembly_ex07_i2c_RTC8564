...
#define OFFSET_CR0	0x000		/*!< Control Register 0. Selects the serial clock rate, bus type, and data size. */
#define OFFSET_CR1	0x004		/*!< Control Register 1. Selects master/slave and other modes. */
#define OFFSET_DR		0x008		/*!< Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO. */
#define OFFSET_SR		0x00c		/*!< Status Register        */
#define OFFSET_CPSR	0x010		/*!< Clock Prescale Register */
#define OFFSET_IMSC	0x014		/*!< Interrupt Mask Set and Clear Register */
#define OFFSET_RIS	0x018		/*!< Raw Interrupt Status Register */
#define OFFSET_MIS	0x01c		/*!< Masked Interrupt Status Register */
#define OFFSET_ICR	0x020		/*!< SSPICR Interrupt Clear Register */
 ...
 */
#define SSP_RORIM  ((uint32_t)(1 << 0))	/**< Overun */
#define SSP_RTIM  ((uint32_t)(1 << 1))/**< TimeOut */
#define SSP_RXIM  ((uint32_t)(1 << 2))/**< Rx FIFO is at least half full */
#define SSP_TXIM  ((uint32_t)(1 << 3))/**< Tx FIFO is at least half empty */
#define SSP_INT_MASK_BITMASK  ((uint32_t)(0xF))

/**
 * @brief SSP Type of Mask Interrupt Status
 */
#define SSP_RORMIS  ((uint32_t)(1 << 0))	/**< Overun */
#define SSP_RTMIS  ((uint32_t)(1 << 1))	/**< TimeOut */
#define SSP_RXMIS  ((uint32_t)(1 << 2))	/**< Rx FIFO is at least half full */
#define SSP_TXMIS  ((uint32_t)(1 << 3))	/**< Tx FIFO is at least half empty */
#define SSP_MASK_INT_STAT_BITMASK  ((uint32_t)(0xF))

/**
 * @brief SSP Type of Raw Interrupt Status
 */
#define SSP_RORRIS   ((uint32_t)(1 << 0))	/**< Overun */
#define SSP_RTRIS   ((uint32_t)(1 << 1)) 	/**< TimeOut */
#define SSP_RXRIS   ((uint32_t)(1 << 2)) 	/**< Rx FIFO is at least half full */
#define SSP_TXRIS   ((uint32_t)(1 << 3)) 	/**< Tx FIFO is at least half empty */
#define SSP_RAW_INT_STAT_BITMASK   ((uint32_t)(0xF))
